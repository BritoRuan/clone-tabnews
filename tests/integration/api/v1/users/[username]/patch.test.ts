...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Anonymous user", () => {
    ...
    it("With empty field 'username''", async () => {
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users/user2020",
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
    ...
    it("With empty field 'password'", async () => {
      const user1Response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        body: JSON.stringify({
          username: "userPasswordEmpty",
          email: "userPasswordEmpty@gmail.com",
          password: "senha12345",
        }),
      });
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users/userPasswordEmpty",
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
